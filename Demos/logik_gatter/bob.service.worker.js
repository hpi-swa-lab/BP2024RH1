...
/** @type {string} */
const CACHE_VERSION = '1745573100|3209960629';
/** @type {string} */
const CACHE_PREFIX = 'beispielquest_lo-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'bob.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["bob.html","bob.js","bob.offline.html","bob.icon.png","bob.apple-touch-icon.png","bob.audio.worklet.js","bob.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["bob.wasm","bob.pck","bob.side.wasm"];
