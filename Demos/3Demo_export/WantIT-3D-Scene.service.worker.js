...
/** @type {string} */
const CACHE_VERSION = '1744026940|13725184087';
/** @type {string} */
const CACHE_PREFIX = 'WantIT-3D-Scene-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'WantIT-3D-Scene.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["WantIT-3D-Scene.html","WantIT-3D-Scene.js","WantIT-3D-Scene.offline.html","WantIT-3D-Scene.icon.png","WantIT-3D-Scene.apple-touch-icon.png","WantIT-3D-Scene.worker.js","WantIT-3D-Scene.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["WantIT-3D-Scene.wasm","WantIT-3D-Scene.pck"];
