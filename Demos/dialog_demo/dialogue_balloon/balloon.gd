...
func apply_dialogue_line() -> void:
	...
	var portrait_path_format: String = "res://assets/characters/%s_%s.png"
	var portrait_path: String = portrait_path_format % [dialogue_line.character.to_lower(), State.emotion]
