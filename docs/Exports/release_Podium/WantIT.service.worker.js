...
/** @type {string} */
const CACHE_VERSION = '1751535631|145827216';
/** @type {string} */
const CACHE_PREFIX = 'WantIT-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'WantIT.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["WantIT.html","WantIT.js","WantIT.offline.html","WantIT.icon.png","WantIT.apple-touch-icon.png","WantIT.audio.worklet.js","WantIT.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["WantIT.wasm","WantIT.pck"];
